...
- `ASE-NIER'25` Ruofan Lu, Yichen Li, Yintong Huo. “Exploring Autonomous Agents: A Closer Look at Why They Fail When Completing Tasks” The IEEE/ACM International Conference on Automated Software Engineering, Seoul, South Korea, Nov 2025.
...
- `TOSEM` Renyi Zhong, **Yichen Li**, Jinxi Kuang, Wenwei Gu,Yintong Huo, Michael R. Lyu. "Automated Detection and Repair of Specific Defects in Logging Statements". ACM Transactions on Software Engineering and Methodology (Journal-First).
