...
- `FSE‘24` **Yichen Li**, Yintong Huo, Renyi Zhong, Zhihan Jiang, Jinyang Liu, Junjie Huang, Jiazhen Gu, Pinjia He and Michael R. Lyu. "[Go Static: Contextualized Logging Statement Generation](todo)". The ACM International Conference on the Foundations of Software Engineering, Porto de Galinhas, Brazil, July 2024.
<<<<<<< HEAD
- `FSE’24` Zhihan Jiang, Jinyang Liu, Zhuangbin Chen, **Yichen Li**, Junjie Huang, Yintong Huo, Pinjia He, Jiazhen Gu and Michael R. Lyu. "[LILAC: Log Parsing using LLMs with Adaptive Parsing Cache](https://arxiv.org/abs/2310.01796)". The ACM International Conference on the Foundations of Software Engineering, Porto de Galinhas, Brazil, July 2024.
- `ICSE-LLM4Code'24` **Yichen Li**, Yun Peng, Yintong Huo and Michael R. Lyu. "[Enhancing LLM-based Coding Tools Through Native Integration of IDE-Derived Static Context.](todo)". The IEEE/ACM International Conference on Software Engineering Workshop on Large Language Model for Code, Lisbon, Portugal, Apr 2024.
=======
- `FSE’24` Zhihan Jiang, Jinyang Liu, Zhuangbin Chen, **Yichen Li**, Junjie Huang, Yintong Huo, Pinjia He, Jiazhen Gu and Michael R. Lyu. "[LILAC: Log Parsing using LLMs with Adaptive Parsing Cache](todo)". The ACM International Conference on the Foundations of Software Engineering, Porto de Galinhas, Brazil, July 2024.
...
>>>>>>> ada486d4b9e60e7e7ce3f7e2f4f913c95294d61d
