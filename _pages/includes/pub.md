...
- `ISSTA'24` Shiwen Shan, Yintong Huo, Yuxin Su, **Yichen Li**, Dan Li, Zibin Zheng. "[Face It Yourselves: An LLM-based Two-Stage Strategy to Localize Configuration Errors via Logs](todo)". The ACM SIGSOFT International Symposium on Software Testing and Analysis, Vienna, Austria, Sep 2024.
